...
import { DAG_ID, DAG_KIND, dagDefinition } from '../src/client/definition.tsx'
...
describe('dagDefinition', () => {
  ...
  it('sits in the builtin band and titles itself from the dictionary', () => {
    const definition = dagDefinition(t)
